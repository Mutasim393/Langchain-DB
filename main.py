    ...
    def handle_query(self, question: str) -> str:
        ...
        if standardized_question:
            ...
            if len(self.dataframes) == 1:  # Single file processing
                response = query_handler.ask_question(self.dataframes[0], standardized_question)
            else:  # Multiple file processing
                response = query_handler.ask_question(self.comparison_summary, standardized_question)
