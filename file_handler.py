...
class FileHandler:
    def __init__(self, file_path=None, connection_string=None):
        ...
        if file_path:
            self.df = self.load_file()  # Load the file if path is provided
    ...
    def load_pdf(self):
        ...
        try:
            ...
            print(f"Loaded PDF file: {self.file_path}")
            return df
        except Exception as e:
    ...
    def load_docx(self):
        ...
        try:
            ...
            df = pd.DataFrame({'Content': ["\n".join(paragraphs)]})
            print(f"Loaded DOCX file: {self.file_path}")
            return df
        except Exception as e:
        ...
        try:
            ...
            with self.engine.connect() as conn:
                ...
                if tables:
                    ...
                    print(f"Loaded SQL file: {self.file_path}")
                    return df
                else:
